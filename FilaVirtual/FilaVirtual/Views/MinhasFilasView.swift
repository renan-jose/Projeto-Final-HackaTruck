...
struct FilaCardView2: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("Tempo médio: \(fila.tempo_medio) minutos")
                .font(.subheadline)

            Text("Próximo número: \(fila.num_prox)")
                .font(.subheadline)

            Text("Número atual: \(fila.num_atual)")
                .font(.subheadline)
        }
        .padding()
...
struct FilasCriadasView2_Previews: PreviewProvider {
