...
class FilaService: ObservableObject {
    ...
    func postFila(_ obj: Fila){ //Aqui deve ser colocado o nome da Struct relacionada
        ...
        guard let url = URL(string: "http://192.168.128.31:1880/postfila") else { return } //Aqui deve ser colocado o IP (local ou da rede) e, depois da barra, o verbo do POST do Node-RED
    ...
    func getfilas(){
        ...
        guard let url = URL(string: "http://192.168.128.31:1880/getfila")else{ //Aqui deve ser colocado o IP (local ou da rede) e, depois da barra, o verbo escolhido no fluxo do GET no Node-RED
            return
        }
...
//                    self?.convertToChartData(dados: parsed)
    ...
    func putfila(_ obj : Fila){
        
        guard let url = URL(string: "http://192.168.128.31:1880/putfila") else { return } //Aqui deve ser escrito o IP (da rede ou local) e, depois da barra, o verbo escolhido no fluxo do PUT no Node-RED
