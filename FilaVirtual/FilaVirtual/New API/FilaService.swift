...
//                    self?.convertToChartData(dados: parsed)
    ...
    func putfila(_ obj : Fila){
        ...
        guard let url = URL(string: "http://127.0.0.1:1880/putfila") else { return } //Aqui deve ser escrito o IP (da rede ou local) e, depois da barra, o verbo escolhido no fluxo do PUT no Node-RED
